...
class ChannelSenseRequest : public ::cPacket
{
  ...
  public:
    ...
    virtual void setSenseMode(int senseMode_var);
    virtual simtime_t getSenseTimeout() const;
    virtual void setSenseTimeout(simtime_t senseTimeout_var);
    ...
    virtual void setResult(const ChannelState& result_var);
};
