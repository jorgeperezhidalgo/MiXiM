//
// Generated file, do not edit! Created by opp_msgc 4.1 from messages/BorderMsg.msg.
//
...
BorderMsg::BorderMsg(const BorderMsg& other) : cPacket()
{
...
void BorderMsg::setPolicy(int policy_var)
{
    this->policy_var = policy_var;
}
...
void BorderMsg::setStartPos(const Coord& startPos_var)
{
    this->startPos_var = startPos_var;
}
...
void BorderMsg::setDirection(const Coord& direction_var)
{
