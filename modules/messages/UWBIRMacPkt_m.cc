...
UWBIRMacPkt_Base::UWBIRMacPkt_Base(const UWBIRMacPkt_Base& other) : MacPkt()
{
...
void UWBIRMacPkt_Base::setNbSymbols(int nbSymbols_var)
{
    this->nbSymbols_var = nbSymbols_var;
}
