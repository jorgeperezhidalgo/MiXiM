//
// Generated file, do not edit! Created by opp_msgc 4.1 from messages/DummyRoutePkt.msg.
//
...
DummyRoutePkt::DummyRoutePkt(const DummyRoutePkt& other) : NetwPkt()
{
...
void DummyRoutePkt::setNetworkID(int networkID_var)
{
    this->networkID_var = networkID_var;
}
