//
// Generated file, do not edit! Created by opp_msgc 4.1 from messages/AirFrameUWBIR.msg.
//
...
AirFrameUWBIR::AirFrameUWBIR(const AirFrameUWBIR& other) : AirFrame()
{
...
void AirFrameUWBIR::setCfg(const IEEE802154A::config& cfg_var)
{
    this->cfg_var = cfg_var;
}
