...
columna_scalar= 11; columna_vector = 0; % Column where the data begins, starts with 0
...
errorbar(1:30,promedio_paquetes(1:30),ci_promedio_paquetes(1:30))
hold on
errorbar(1:30,promedio_paquetes(31:60),ci_promedio_paquetes(31:60),'r')
errorbar(1:30,promedio_paquetes(61:90),ci_promedio_paquetes(61:90),'g')
errorbar(1:30,promedio_paquetes(91:120),ci_promedio_paquetes(91:120),'k')
errorbar(1:30,promedio_paquetes(121:150),ci_promedio_paquetes(121:150),'y')