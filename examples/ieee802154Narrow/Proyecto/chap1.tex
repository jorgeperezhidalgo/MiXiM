...
These reasons combined with the low prices of 802.15.4 nodes compared with the other alternatives \cite{802154Scalability}, made this 
...
As it will be seen in Chapter \ref{chap:protocoldesign}: \nameref{chap:protocoldesign}, this kind of applications will conclude in 4 different 
...
presented. This chapter will also include some possible future work and improvements that this protocol could have.
 \item \textbf{Appendix \ref{chap:installation}: \nameref{chap:installation}.} Contains a manual about how to install and configure 
...
given.
 \item \textbf{Appendix \ref{chap:acronyms}: \nameref{chap:acronyms}.} Contains a list of the used acronyms during this work.
\end{itemize}
