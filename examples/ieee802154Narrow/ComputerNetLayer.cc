...
void ComputerNetLayer::initialize(int stage) {
	BaseNetwLayer::initialize(stage);
	if (stage == 0) {
	}
}
void ComputerNetLayer::finish() {
}
 ...
 **/
void ComputerNetLayer::handleLowerMsg(cMessage* msg)
{
 ...
 **/
void ComputerNetLayer::handleUpperMsg(cMessage* msg)
{
 ...
 * from upper layers.
 **/
void ComputerNetLayer::handleUpperControl(cMessage* msg)
{
	sendControlDown(msg);
}
 ...
 * header fields.
 **/
NetwPkt* ComputerNetLayer::encapsMsg(cPacket *appPkt) {
    int macAddr;
    int netwAddr;
